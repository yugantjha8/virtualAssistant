...
def respond(voice_data):
    ...
    if there_exists(["what is your name","what's your name","tell me your name"]):
        if person_obj.name:
            ...
            engine_speak("My name is Kim . what's your name?")
    ...
    if there_exists(["who created you"]):
        engine_speak("Yugant Rishi Rishab Shatru are my creaters ")

    # 6: search google --> search for money heist movie
    ...
    # 7: search youtube --> youtube channel of mortal, youtube video of thinkschool
    ...
    # 8: get stock price --> price of infosys, reliance
    ...
    # 9: search for music --> play music stay
    ...
    # 10: to open amazon --> open amazon.com
    ...
    if there_exists(["game","we should play a game"]):
    ...
    # 19: to search wikipedia for definition
    ...
    # 20: bahr nikalne ke liye
    if there_exists(["exit", "quit", "goodbye"]):
        engine_speak("we could continue more master, but.,,...,,,,,..,,,,, byee")
        exit()
...
while(1):
    voice_data = record_audio("Your turn") # get the voice input
    print("Done")
    print("Q:", voice_data)
